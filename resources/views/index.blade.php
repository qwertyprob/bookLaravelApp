<x-layout title="Главная страница">
    ...
    <div class="container">
        ...
        <!-- По 6 карточек в ряду (col-2 на lg, col-4 на md, col-6 на sm) -->
        <div class="row gx-3 gy-4 p-3">
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Карточка 4</h5>
                        <p class="card-text">Описание карточки 4.</p>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Карточка 5</h5>
                        <p class="card-text">Описание карточки 5.</p>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Карточка 6</h5>
                        <p class="card-text">Описание карточки 6.</p>
                    </div>
                </div>
            </div>
        </div>
