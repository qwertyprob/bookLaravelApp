...
<footer class="footer py-3 h-100" style="background-color: var(--blue-color-); width: 100%;">  
  <div class="container" style="background-color: var(--blue-color-); width: 100%;">
    <div class="row d-flex justify-content-between align-items-start">
      <div class="col-12 col-md-4 p-1 py-0">
            <h1>О себе:</h1>
            <img src="/img/photo.jpg" class="bio-photo">
            <p>
  Я — <strong>начинающий PHP-разработчик</strong>, увлечённый созданием веб-приложений.  
  Имею <strong>базовые знания в JavaScript</strong> и опыт работы с веб-технологиями на платформе <strong>.NET</strong>.  
  Люблю разрабатывать <strong>функциональные и аккуратные сайты</strong>, интересуюсь вопросами информационной безопасности  
  и стремлюсь писать <strong>надёжный, чистый код</strong>.  
  В настоящее время активно <strong>изучаю фреймворк Laravel</strong> и развиваю навыки <strong>современной веб-разработки</strong>.
</p>
  ...
  Здесь можно <strong>искать и добавлять книги</strong>, делиться описаниями и просто наслаждаться простым и понятным интерфейсом.  
